...
extern const struct Chr_row_descr addr_font[64][CHR_HEIGHT];
extern const unsigned char font_map[91];
extern const unsigned char addr_font_data[35984];
...
extern const uint16_t bitcoin_fragment[];
enum {
    BITCOIN_FRAGMENT_WIDTH  = 18,
    BITCOIN_FRAGMENT_HEIGHT = 5
};
extern const uint16_t litecoin_fragment[];
enum {
    LITECOIN_FRAGMENT_WIDTH  = 20,
    LITECOIN_FRAGMENT_HEIGHT = 5
};
extern const uint16_t peercoin_fragment[];
enum {
    PEERCOIN_FRAGMENT_WIDTH  = 22,
    PEERCOIN_FRAGMENT_HEIGHT = 5
};
extern const uint16_t address_fragment[];
enum {
    ADDRESS_FRAGMENT_WIDTH  = 20,
    ADDRESS_FRAGMENT_HEIGHT = 5
};
extern const uint16_t account_fragment[];
enum {
    ACCOUNT_FRAGMENT_WIDTH  = 21,
    ACCOUNT_FRAGMENT_HEIGHT = 5
};
...
extern const uint16_t seed_fragment[];
enum {
    SEED_FRAGMENT_WIDTH  = 13,
    SEED_FRAGMENT_HEIGHT = 5
};
...
extern const uint16_t keep_safe_fragment[];
enum {
    KEEP_SAFE_FRAGMENT_WIDTH  = 21,
    KEEP_SAFE_FRAGMENT_HEIGHT = 5
};
extern const uint16_t logo_top_fragment[];
enum {
    LOGO_TOP_FRAGMENT_WIDTH  = 10,
    LOGO_TOP_FRAGMENT_HEIGHT = 20
};
extern const uint16_t logo_middle_fragment[];
enum {
    LOGO_MIDDLE_FRAGMENT_WIDTH  = 42,
    LOGO_MIDDLE_FRAGMENT_HEIGHT = 25
};
...
// JPEG header.
extern const unsigned char jpeg_header[423];
